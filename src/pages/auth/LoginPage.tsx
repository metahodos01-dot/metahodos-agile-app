      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <div className="flex flex-col items-center mb-4">
            <MetahodosCircles size="lg" className="mb-3" />
            <h1 className="text-3xl font-bold text-metahodos-navy">METAHODOS.AGILE.AI</h1>
          </div>
          <p className="mt-2 text-metahodos-text-secondary">
            Accedi al tuo account per continuare
          </p>
          <p className="mt-1 text-xs text-metahodos-text-muted font-medium">
        ...
        <MetahodosCard>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-end">
              <Link
                to="/reset-password"
                className="text-sm text-metahodos-orange hover:text-metahodos-orange-dark transition-colors"
              >
          ...
          <div className="mt-6 text-center text-sm">
            <span className="text-metahodos-text-secondary">Non hai un account? </span>
            <Link
              to="/signup"
